export default function Feedback(){
    ...
    const userURL = "https://t4.ftcdn.net/jpg/02/29/75/83/360_F_229758328_7x8jwCwjtBMmC6rgFzLFhZoEpLobB6L8.jpg"
    return(


<>
    <div class="flex items-center mb-4">
        <img class="w-10 h-10 me-4 rounded-full" src={userURL} alt=""/>
        <div class="font-medium dark:text-white">
            <p className="text-black">Jese Leos <time datetime="2014-08-16 19:00" class="block text-sm text-gray-500 dark:text-gray-400">Joined on August 2014</time></p>
        </div>
    </div>

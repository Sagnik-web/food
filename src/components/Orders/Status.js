      ...
      <div className="relative pb-8">
        ...
        <div className="relative flex space-x-3">
          ...
          <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
            <div>
              <p className="text-sm text-gray-500">packing at <a href="#" className="font-medium text-gray-900">France</a></p>
            </div>
    ...
    <li>
      <div className="relative pb-8">
        ...
        <div className="relative flex space-x-3">
          ...
          <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
            <div>
              <p className="text-sm text-gray-500">with driver <a href="#" className="font-medium text-gray-900">on the way to the plane</a></p>
            </div>
            <div className="whitespace-nowrap text-right text-sm text-gray-500">
    ...
    <li>
      <div className="relative pb-8">
        ...
        <div className="relative flex space-x-3">
          ...
          <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
            <div>
              <p className="text-sm text-gray-500">on plane ready to fly <a href="#" className="font-medium text-gray-900"> to london</a></p>
            </div>
            <div className="whitespace-nowrap text-right text-sm text-gray-500">
    ...
    <li>
      <div className="relative pb-8">
        ...
        <div className="relative flex space-x-3">
          ...
          <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
            <div>
              <p className="text-sm text-gray-500">with driver <a href="#" className="font-medium text-gray-900">on the way to you</a></p>
            </div>
            <div className="whitespace-nowrap text-right text-sm text-gray-500">
    ...
    <li>
      <div className="relative pb-8">
        <div className="relative flex space-x-3">
          ...
          <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
            <div>
              <p className="text-sm text-gray-500">wait outside the door <a href="#" className="font-medium text-gray-900">the driver is close</a></p>
            </div>
            <div className="whitespace-nowrap text-right text-sm text-gray-500">
